...
}; //End of gdjs.NewSceneCode.eventsList0x6f69cc
...
{ //Subevents
gdjs.NewSceneCode.eventsList0x6f421c(runtimeScene);} //End of subevents
}
...
{ //Subevents
gdjs.NewSceneCode.eventsList0x6f69cc(runtimeScene);} //End of subevents
}
...
{
for(var i = 0, k = 0, l = gdjs.NewSceneCode.GDPlayerObjects1.length;i<l;++i) {
    if ( gdjs.NewSceneCode.GDPlayerObjects1[i].getX() < 5800 ) {
        gdjs.NewSceneCode.condition0IsTrue_0.val = true;
        gdjs.NewSceneCode.GDPlayerObjects1[k] = gdjs.NewSceneCode.GDPlayerObjects1[i];
        ++k;
    }
