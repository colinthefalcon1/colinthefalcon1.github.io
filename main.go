...
const (
	scaledroneID     = "fmdU6Sbit5NwRD6Z"     // 👈 PS! Replace this with your own channel ID 🚨
	scaledroneSecret = "cKMKhzqfnJopGnkhqhVUkfs3YYZ2kV16" // 👈 PS! Replace this with your own channel secret 🚨
	port             = ":8080"
)
